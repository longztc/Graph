/* Copyright (c) Microsoft Corporation. All rights reserved.
   This file was modified by Ibiza Portal team.
   All modifications are commented with keyword: 'modification'.
	...
	/** Create the date entry plugin.
		...
		/** Default settings for the plugin.
			...
			@property [altField=null] {string|Element|jQuery} Selector, element, or jQuery object
						for an alternate field to keep synchronized.
		...
		_adjustField: function(inst, offset) {
			...
			// modification by jjed: to ensure reparsing when date is changed through DatePanel
			plugin._parseDate(inst);
			// end of modification
			var field = inst.options.dateFormat.charAt(inst._field);
